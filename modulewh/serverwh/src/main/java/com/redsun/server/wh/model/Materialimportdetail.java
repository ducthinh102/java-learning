...
@Entity
@Table(name="materialimportdetail", schema="public" )
public class Materialimportdetail implements Serializable
{
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    @Column(name="idmaterialimport")
    private Integer    idmaterialimport ;
    ...
    //----------------------------------------------------------------------
    //--- DATABASE MAPPING : idmaterialimport ( int4 ) 
    public void setIdmaterialimport( Integer idmaterialimport )
    {
        this.idmaterialimport = idmaterialimport;
    }
    public Integer getIdmaterialimport()
    {
        return this.idmaterialimport;
    }
	...
	public String toString() {
        ...
        sb.append("\"id\":");
        sb.append(id);
    	sb.append(",\"idmaterialimport\":");
        value = idmaterialimport == null ? "null" : "\"" + idmaterialimport + "\"";
        sb.append(value);
	...
	@JoinColumn(name="idmaterialimport", nullable=true, insertable=false, updatable=false)
	@JsonIgnore
	private Materialimport materialimport;
	public Materialimport getMaterialimport() {
		return materialimport;
	}
	public void setMaterialimport(Materialimport materialimport) {
