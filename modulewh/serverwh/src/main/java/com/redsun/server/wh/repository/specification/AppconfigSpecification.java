...
public class AppconfigSpecification implements Specification<Appconfig> {
	...
	public AppconfigSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Appconfig> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
