...
public class CalendardefineSpecification implements Specification<Calendardefine> {
	...
	public CalendardefineSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Calendardefine> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
