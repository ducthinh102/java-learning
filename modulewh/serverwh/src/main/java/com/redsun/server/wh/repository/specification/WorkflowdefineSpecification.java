...
public class WorkflowdefineSpecification implements Specification<Workflowdefine> {
	...
	public WorkflowdefineSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Workflowdefine> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
