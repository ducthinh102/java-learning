...
public class CommentRestController {
	...
	public ResponseEntity<?> listWithCriteriasByIdrefAndReftypeAndPage(@PathVariable("idref") Integer idref, @PathVariable("reftype") String reftype, @RequestBody List<SearchCriteria> searchCriterias, Pageable pageable) {
		Page<Map<String, Object>> comments = commentService.listWithCriteriasByIdrefAndReftypeAndPage(idref, reftype, searchCriterias, pageable);
		// return.
		return new ResponseEntity<Page<Map<String, Object>>>(comments, HttpStatus.OK);
	}
