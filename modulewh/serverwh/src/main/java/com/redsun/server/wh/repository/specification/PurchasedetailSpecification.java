...
public class PurchasedetailSpecification implements Specification<Purchasedetail> {
	...
	public PurchasedetailSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Purchasedetail> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
