...
public class MaterialbaselineSpecification implements Specification<Materialbaseline> {
	...
	public MaterialbaselineSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Materialbaseline> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
