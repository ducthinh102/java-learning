...
@Entity
@Table(name="materialformdetail", schema="public" )
public class Materialformdetail implements Serializable
{
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    @Column(name="idmaterialform")
    private Integer    idmaterialform ;
    ...
    //----------------------------------------------------------------------
    //--- DATABASE MAPPING : idmaterialform ( int4 ) 
    public void setIdmaterialform( Integer idmaterialform )
    {
        this.idmaterialform = idmaterialform;
    }
    public Integer getIdmaterialform()
    {
        return this.idmaterialform;
    }
	...
	public String toString() {
        ...
        sb.append("\"id\":");
        sb.append(id);
    	sb.append(",\"idmaterialform\":");
        value = idmaterialform == null ? "null" : "\"" + idmaterialform + "\"";
        sb.append(value);
	...
	@JoinColumn(name="idmaterialform", nullable=true, insertable=false, updatable=false)
	@JsonIgnore
	private Materialform materialform;
	public Materialform getMaterialform() {
		return materialform;
	}
	public void setMaterialform(Materialform materialform) {
