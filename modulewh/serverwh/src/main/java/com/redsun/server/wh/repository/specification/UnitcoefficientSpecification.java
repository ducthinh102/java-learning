...
public class UnitcoefficientSpecification implements Specification<Unitcoefficient> {
	...
	public UnitcoefficientSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Unitcoefficient> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
