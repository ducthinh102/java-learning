...
@Entity
@Table(name="materialform", schema="public" )
public class Materialform implements Serializable
{
    ...
    //--- DATABASE MAPPING : formdate ( date ) 
	...
	public String toString() {
        ...
        sb.append(value);
    	sb.append(",\"formdate\":");
        value = formdate == null ? "null" : "\"" + formdate + "\"";
        sb.append(value);
    	sb.append(",\"note\":");
	...
	// materialformdetail.
		@OneToMany(mappedBy="materialform", cascade=CascadeType.ALL, fetch=FetchType.LAZY)
		@JsonIgnore
		private Set<Materialformdetail> materialformdetails;
