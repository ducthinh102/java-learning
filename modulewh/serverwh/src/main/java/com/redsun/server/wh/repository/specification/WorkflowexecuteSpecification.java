...
public class WorkflowexecuteSpecification implements Specification<Workflowexecute> {
	...
	public WorkflowexecuteSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Workflowexecute> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
