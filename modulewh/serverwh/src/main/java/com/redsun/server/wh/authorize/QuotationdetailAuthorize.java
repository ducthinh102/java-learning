...
import com.redsun.server.wh.controller.QuotationdetailRestController;
...
@Component("quotationdetailAuthorize")
public class QuotationdetailAuthorize {

	public static final Logger logger = LoggerFactory.getLogger(QuotationdetailRestController.class);
	...
	public boolean canCreate(Quotationdetail quotationdetail) throws JsonParseException, JsonMappingException, IOException {
		return true;
	}
	...
	public boolean canUpdate(Quotationdetail quotationdetail) throws JsonParseException, JsonMappingException, IOException {
		return true;
	}
