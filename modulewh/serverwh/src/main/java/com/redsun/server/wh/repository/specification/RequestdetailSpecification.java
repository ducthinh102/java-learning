...
public class RequestdetailSpecification implements Specification<Requestdetail> {
	...
	public RequestdetailSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Requestdetail> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
