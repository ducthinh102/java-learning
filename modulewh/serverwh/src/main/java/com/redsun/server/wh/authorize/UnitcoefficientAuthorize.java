...
import com.redsun.server.wh.controller.UnitcoefficientRestController;
...
@Component("unitcoefficientAuthorize")
public class UnitcoefficientAuthorize {
	...
	@Autowired
	UnitcoefficientRepository unitcoefficientRepository;

	public boolean canCreate(Unitcoefficient unitcoefficient) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		result = permissionAuthorize.isCreate("unitcoefficient", iduser);
	...
	public boolean canRead(Integer id) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		Map<String, Object> authorizeProperties = unitcoefficientRepository.getAuthorizePropertiesById(id).get(0);
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isRead("unitcoefficient", iduser, idcreate, idowner);

		return result;
	}
	
	public boolean canUpdate(Unitcoefficient unitcoefficient) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		Map<String, Object> authorizeProperties = unitcoefficientRepository.getAuthorizePropertiesById(unitcoefficient.getId()).get(0);
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isUpdate("unitcoefficient", iduser, idcreate, idowner);
	...
	public boolean canDelete(Integer id) throws JsonParseException, JsonMappingException, IOException {
		...
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isDelete("unitcoefficient", iduser, idcreate, idowner);
	...
	public boolean canList(List<SearchCriteria> searchCriterias) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		result = permissionAuthorize.isList(searchCriterias, "unitcoefficient");
