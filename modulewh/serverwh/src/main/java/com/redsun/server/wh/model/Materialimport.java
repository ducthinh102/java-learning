...
@Entity
@Table(name="materialimport", schema="public" )
public class Materialimport implements Serializable {
    ...
    @Column(name="idimporter")
    private Integer    idimporter   ;
	...
	// GETTERS & SETTERS FOR FIELDS
	// ----------------------------------------------------------------------
	// --- DATABASE MAPPING : idimporter ( int4 )
	public Integer getIdimporter() {
		return idimporter;
    }

	public void setIdimporter(Integer idimporter) {
    ...
    //--- DATABASE MAPPING : importdate ( date ) 
	...
	public String toString() {
        ...
        sb.append(value);
    	sb.append(",\"idimporter\":");
        value = idimporter == null ? "null" : "\"" + idimporter + "\"";
        sb.append(value);
    	sb.append(",\"idref\":");
        ...
        value = importdate == null ? "null" : "\"" + importdate + "\"";
        sb.append(value);
    	sb.append(",\"note\":");
	...
	// materialimportdetails.
	@OneToMany(mappedBy = "materialimport", cascade = CascadeType.ALL, fetch = FetchType.LAZY)
	@JsonIgnore
	private Set<Materialimportdetail> materialimportdetails;
	...
	// material.
	@OneToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "idimporter", nullable = true, insertable = false, updatable = false)
	@JsonIgnore
	private User user;
