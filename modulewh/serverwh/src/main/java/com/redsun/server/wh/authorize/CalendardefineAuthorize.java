...
import com.redsun.server.wh.controller.CalendardefineRestController;
...
@Component("calendardefineAuthorize")
public class CalendardefineAuthorize {
	...
	@Autowired
	CalendardefineRepository calendardefineRepository;

	public boolean canCreate(Calendardefine calendardefine) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		result = permissionAuthorize.isCreate("calendardefine", iduser);
	...
	public boolean canRead(Integer id) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		Map<String, Object> authorizeProperties = calendardefineRepository.getAuthorizePropertiesById(id).get(0);
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isRead("calendardefine", iduser, idcreate, idowner);

		return result;
	}
	
	public boolean canUpdate(Calendardefine calendardefine) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		Integer iduser = SecurityUtil.getIdUser();
		Map<String, Object> authorizeProperties = calendardefineRepository.getAuthorizePropertiesById(calendardefine.getId()).get(0);
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isUpdate("calendardefine", iduser, idcreate, idowner);
	...
	public boolean canDelete(Integer id) throws JsonParseException, JsonMappingException, IOException {
		...
		Integer idcreate = (Integer)authorizeProperties.get("idcreate");
		Integer idowner = (Integer)authorizeProperties.get("idowner");
		result = permissionAuthorize.isDelete("calendardefine", iduser, idcreate, idowner);
	...
	public boolean canList(List<SearchCriteria> searchCriterias) throws JsonParseException, JsonMappingException, IOException {
		boolean result = true;
		result = permissionAuthorize.isList(searchCriterias, "calendardefine");
