...
@Entity
@Table(name="unitcoefficient", schema="public" )
public class Unitcoefficient implements Serializable
{
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    @Column(name="idfromunit")
    private Integer    idfromunit   ;

    @Column(name="idtounit")
    private Integer    idtounit     ;
    ...
    //----------------------------------------------------------------------
    //--- DATABASE MAPPING : idfromunit ( int4 ) 
    public void setIdfromunit( Integer idfromunit )
    {
        this.idfromunit = idfromunit;
    }
    public Integer getIdfromunit()
    {
        return this.idfromunit;
    }

    //--- DATABASE MAPPING : idtounit ( int4 ) 
    public void setIdtounit( Integer idtounit )
    {
        this.idtounit = idtounit;
    }
    public Integer getIdtounit()
    {
        return this.idtounit;
    }

    //--- DATABASE MAPPING : coefficient ( int4 ) 
	...
	public String toString() {
        ...
        sb.append("\"id\":");
        sb.append(id);
    	sb.append(",\"idfromunit\":");
        value = idfromunit == null ? "null" : "\"" + idfromunit + "\"";
        sb.append(value);
    	sb.append(",\"idtounit\":");
        value = idtounit == null ? "null" : "\"" + idtounit + "\"";
        sb.append(value);
    	sb.append(",\"coefficient\":");
        value = coefficient == null ? "null" : "\"" + coefficient + "\"";
        sb.append(value);
    	sb.append(",\"note\":");
