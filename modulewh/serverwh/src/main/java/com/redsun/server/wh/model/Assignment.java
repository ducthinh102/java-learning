...
public class Assignment implements Serializable
{
    ...
    // ENTITY DATA FIELDS 
    //----------------------------------------------------------------------    
    @Column(name="idworkflowexecute")
    private Integer    idworkflowexecute;
    ...
    //----------------------------------------------------------------------
    //--- DATABASE MAPPING : idworkflowexecute ( int4 ) 
    public void setIdworkflowexecute( Integer idworkflowexecute )
    {
        this.idworkflowexecute = idworkflowexecute;
    }
    public Integer getIdworkflowexecute()
    {
        return this.idworkflowexecute;
    }
    ...
    //--- DATABASE MAPPING : idassignee ( int4 ) 
    ...
    //--- DATABASE MAPPING : sortorder ( int4 ) 
	...
	public String toString() {
        ...
        sb.append("\"id\":");
        sb.append(id);
    sb.append(",\"idworkflowexecute\":");
    		value = idworkflowexecute == null ? "null" : "\"" + idworkflowexecute + "\"";
    	sb.append(",\"idref\":");
        value = idref == null ? "null" : "\"" + idref + "\"";
        sb.append(value);
    	sb.append(",\"idassignee\":");
        value = idassignee == null ? "null" : "\"" + idassignee + "\"";
        sb.append(value);
    	sb.append(",\"reftype\":");
