...
app.aService(clientwh.prefix + 'materialService', function($http, $rootScope) {
	...
	//Load material where idref = 0 
	this.loadAllMaterialConfirmed = function() {
		var serverUrl = clientwh.serverUrl + '/material/loadAllMaterialConfirmed/';
		var request = {
				 method: 'GET',
				 url: serverUrl
		}
	...
	//Load material from baseline by idstore for select.
	this.loadAllFromBaselineByIdstore = function(idstore) {
		var serverUrl = clientwh.serverUrl + '/material/loadAllFromBaselineByIdstore/' + idstore;
		var request = {
				 method: 'GET',
				 url: serverUrl
		}
	...
	// Get by Id.
	this.getByIdForView = function(materialId) {
		var serverUrl = clientwh.serverUrl + '/material/getByIdForView/' + materialId;
		var request = {
				 method: 'GET',
				 url: serverUrl
				}
