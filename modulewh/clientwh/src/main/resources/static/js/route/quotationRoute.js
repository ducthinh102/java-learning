...
define(['require'], function (require) {
	app.aStateProvider
	.state(clientwh.prefix + 'quotation', {
		parent: clientwh.prefix + 'main',
		url: clientwh.contextPath + '/quotation',
		params: {
		    'reftype': null, 
		    'formcopy': null, 
		    'formdetailcopy': null
		...
		resolve: {
            loadRequire: ['$ocLazyLoad', '$q', function ($ocLazyLoad, $q) {
                ...
                require([
                	...
                	clientwh.contextPath + '/js/service/quotationdetailService.js', clientwh.contextPath + '/js/controller/quotationdetailController.js',
                	clientwh.contextPath + '/js/service/supplierService.js', clientwh.contextPath + '/js/controller/supplierController.js',
                	...
                	clientwh.contextPath + '/js/service/quotationService.js', clientwh.contextPath + '/js/controller/quotationController.js'], function () {
		...
		views: {
			'container': {
				templateUrl: clientwh.contextPath + '/view/quotation_list.html',
				controller: clientwh.prefix + 'quotationController'
			}
		}
	});
