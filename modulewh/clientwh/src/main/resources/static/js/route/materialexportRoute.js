/**
 * Route for Materialexport
 **/

define(['require'], function (require) {
	app.aStateProvider
	.state(clientwh.prefix + 'materialexport', {
		parent: clientwh.prefix + 'main',
		url: clientwh.contextPath + '/materialexport',
		params: {
		    'reftype': null, 
		    'formcopy': null, 
		    'formdetailcopy': null
		...
		resolve: {
            loadRequire: ['$ocLazyLoad', '$q', function ($ocLazyLoad, $q) {
                ...
                require([
                	...
                	clientwh.contextPath + '/js/controller/materialexportdetailController.js',
                	clientwh.contextPath + '/js/service/materialexportService.js', 
                	clientwh.contextPath + '/js/controller/materialexportController.js'], function () {
		...
		views: {
			'container': {
				templateUrl: clientwh.contextPath + '/view/materialexport_list.html',
				controller: clientwh.prefix + 'materialexportController'
			}
		}
	});
