...
define(['require', 'angular'], function (require, angular) {
	...
	app.aController(clientwh.prefix + 'testController', function($scope, $state, $rootScope, $mdDialog, $http, $log, $window, $location, $filter, $translate, $translatePartialLoader, $element, moment, testService) {
...
*/		
	    ...
	    $scope.showDialog = function (dialog) {
	        var htmlUrlTemplate = clientwh.contextPath + '/view/test_list.html';
		...
		$scope.showDialogWithController = function() {
			var htmlUrlTemplate = clientwh.contextPath + '/view/client_list.html';
			clientwh.showDialogWithControllerName(clientwh.prefix + 'clientController', 'clientController', $mdDialog, htmlUrlTemplate).then(function(evt) {
	        	console.log('closed');
	        }, function(evt) {
	        	console.log('not closed');
	        });
