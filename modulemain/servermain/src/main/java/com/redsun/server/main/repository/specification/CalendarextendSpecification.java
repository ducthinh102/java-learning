...
public class CalendarextendSpecification implements Specification<Calendarextend> {
	...
	public CalendarextendSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<Calendarextend> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
