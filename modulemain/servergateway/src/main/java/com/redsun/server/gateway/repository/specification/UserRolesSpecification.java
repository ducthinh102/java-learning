...
public class UserRolesSpecification implements Specification<UserRoles> {
	...
	public UserRolesSpecification(SearchCriteria searchCriteria) {
		this.searchCriteria = searchCriteria;
	}

	@Override
    public Predicate toPredicate(Root<UserRoles> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
